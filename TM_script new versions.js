...
window.addEventListener("load", function () {
    ...
    if (targetSpan) {
        ...
        if (override === "underviser")
            scriptUrl = 'https://kaffannen.github.io/Solution/Compiled/Test/TMTeacherProtoMain_Bundle.js';
        else if (override === "student")
            scriptUrl = 'https://kaffannen.github.io/Solution/Compiled/Test/TMStudentProtoMain_Bundle.js';
        else
            scriptUrl = 'https://kaffannen.github.io/Solution/Compiled/Prod/TMMain_Bundle.js';
